...
(function () {
	...
	function reporter(messages) {
		var report = messages.map(function (mes) {
			return {
		...
		(0, _dedupe2.default)(report).forEach(function (mes) {
			var text = mes.type === 'warning' ? _chalk2.default.yellow('' + mes.text) : _chalk2.default.red('{mes.text}');
